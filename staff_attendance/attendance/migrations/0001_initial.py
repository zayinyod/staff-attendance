        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "time_stamp",
                    models.DateTimeField(
                        default="2024.10.09 19:10:46", verbose_name="日時"
                    ),
                ),
                (
                    "clock",
                    models.CharField(
                        choices=[("clock_in", "出勤"), ("clock_out", "退勤")],
                        max_length=20,
                        verbose_name="in/out",
                    ),
                ),
                ...
                (
                    "location",
                    models.CharField(
                        choices=[("office", "オフィス"), ("telework", "在宅")],
                        default="office",
                        max_length=20,
                        verbose_name="勤務場所",
                    ),
            ...
            options={
                "constraints": [
                    models.UniqueConstraint(
                        fields=("user", "time_stamp", "clock"), name="clock_unique"
                    )
                ],
            },
        ),
